...
(function (global, factory) {
  ...
  exports = module.exports = function (Discourse, actionTypeEnum) {
    ...
    Discourse.prototype.createUser = function (_ref, options, callback) {
      var name = _ref.name,
          email = _ref.email,
    ...
    Discourse.prototype.filterUsersSync = function (filter) {
      return JSON.parse(this.getSync('admin/users/list/active.json', {
        filter: filter,
        show_emails: true
      }, true).body);
    };

    Discourse.prototype.getUser = function (_ref2, options, callback) {
      ...
      this.get({
        ...
        try {
          ...
          if (json.user.id) return callback(null, json);else return callback(null, null);
        } catch (err) {
    ...
    Discourse.prototype.fetchConfirmationValue = function (callback) {
      ...
      this.get('users/hp.json', {}, function (error, body, httpCode) {
        callback(error, body, httpCode);
      });
    };
